...
iface = gr.Interface(fn=run, inputs=[
    ...
    gr.Image(type="filepath", label='Backgrounds - optional, specified backgrounds'), 
    gr.Slider(label="Backgrounds_complexity - How complicated you wish to the generated image to be", default=0, step=1, minimum=-30, maximum=30),
    gr.Slider(label="Size - Object pixel rates", default=0.1, step=0.02, minimum=0.01, maximum=0.5),
    gr.Slider(label="Angle - Object angle", default=0, step=10, minimum=-180, maximum=180),
    gr.Slider(label="Steps - more steps can increase quality but will take longer to generate",default=10,maximum=100,minimum=1,step=1),
    gr.Slider(label="num_of_Images - How many images you wish to generate", default=2, step=1, minimum=1, maximum=4),
